...
BOOL rimBetaDisabled()
{
	dispatch_once(&rimBetaDisabledOnce,^()
	{
		...
		if([process containsString:@"Folx.app"]||[process containsString:@"Blackmagic Disk Speed Test.app"]||[process containsString:@".prefPane"]||[process containsString:@"Siri.app"]||[process containsString:@"PrivateFrameworks"]||[process containsString:@"Simulator.app"]||[process containsString:@"NotificationCenter.app"]||[process containsString:@"Spotlight.app"])
		{
